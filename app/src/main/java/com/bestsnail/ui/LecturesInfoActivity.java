    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _mToolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                Toast.makeText(LecturesInfoActivity.this, "报名", Toast.LENGTH_SHORT).show();
                baoMing();
                return true;
            }
        });
...
//TODO
        Student student = new Library().getStudent();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            //进行报名
            //访问网络处理
            Toast.makeText(this, lecturesTable.getLec_title(), Toast.LENGTH_SHORT).show();
