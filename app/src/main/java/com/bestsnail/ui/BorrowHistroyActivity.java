...
public class BorrowHistroyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_borrow_histroy);
    ...
    private void initView() {
        ...
        madapter = new BorrowHistroyLoadMoreAdapter(this, borrowTables);
        ...
        madapter.setOnItemClickListener(new BaseRecyclerAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View itemView, int pos) {
                Intent  intent = new Intent(BorrowHistroyActivity.this,BorrowHistroyInfoActivity.class);
                intent.putExtra("falg",mlist.get(pos));
                startActivity(intent);
                finish();
                //TODO 每个item的点击时间
                Toast.makeText(BorrowHistroyActivity.this, "pos:" + pos, Toast.LENGTH_SHORT).show();
            }
        });
                ...
                new FootLoadScrollListener() {
                    ...
                    public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                        ...
                        if (isScrollEnd(recyclerView, newState)) {
                            page++;
                            ((BorrowHistroyLoadMoreAdapter) madapter).setFooterStatus(BorrowHistroyLoadMoreAdapter.LOADING);//更新正在拼命加载文字
                            HttpUtils httpUtils = new HttpUtils();
                            String url = GetHttp.getHttpConnetion() + "BorrowingHistoryServlet";
                            ...
                            httpUtils.send(HttpMethod.POST, url, pre, new RequestCallBack<String>() {
                                ...
                                public void onSuccess(ResponseInfo<String> responseInfo) {
                                    ...
                                    if ("no".equals(result)) {
                                        ((BorrowHistroyLoadMoreAdapter) madapter).setFooterStatus(BorrowHistroyLoadMoreAdapter.NO_MORE);//更新文字没有更多了
                                    } else {
                                        ...
                                        if(list.size()<5){
                                            ((BorrowHistroyLoadMoreAdapter) madapter).setFooterStatus(BorrowHistroyLoadMoreAdapter.NOMORE);
                                        }
                                        for (BorrowTable i :
                                                list) {
                            ...
                            Toast.makeText(BorrowHistroyActivity.this, "没有更多数据", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
        );
        ...
        _mSwipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                httpUtils.send(HttpMethod.POST, url, pre, new RequestCallBack<String>() {
                    ...
                    @Override
                    public void onFailure(HttpException error, String msg) {
                        Toast.makeText(BorrowHistroyActivity.this, "请检查网络", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
